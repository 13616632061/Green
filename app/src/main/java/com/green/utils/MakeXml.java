...
public class MakeXml {
    ...
    private final static double dw = 750;
    private final static double dh = 1373;
    ...
    public static void makeString(int w, int h) {
        ...
        sb.append(WTemplate.replace("{0}", "750").replace("{1}", w + ""));
        sb.append("</resources>");
        ...
        sb2.append(HTemplate.replace("{0}", "1373").replace("{1}", h + ""));
        sb2.append("</resources>");
